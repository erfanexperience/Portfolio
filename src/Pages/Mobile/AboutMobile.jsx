...
import aboutVideoMobile from "./Assets/aboutMedia.webm";
...
const AboutMobile = () => {
  return (
    <div className={styles.aboutMobileContainer}>
      <h1 className={styles.aboutMobileTitle}>Who I am?</h1>

      <div className={styles.videoContainer}>
        <video className={styles.aboutVideo} autoPlay loop muted playsInline>
          <source src={aboutVideoMobile} type="video/webm" />
